...
const Footer = () => {
  ...
  return (
    <div className='bg-[url(/images/footer-bg.png)] bg-cover bg-center bg-no-repeat rounded-t-[1rem] mt-[8rem] overflow-hidden'>
        <div className='w-full h-full bg-red/95 px-[12rem] pt-[4rem]'>
            <div className='flex justify-between'>
                <div>
                    <img src="/logo.svg" alt="logo" draggable={false} className='w-[20rem]'/>
                    <p className='text-light-white font-open-sans font-bold text-[1.125rem] max-w-[21.3125rem] mt-[1.5rem]'>{ t('footerInfo') }</p>
                </div>

                <div className='flex gap-[3rem] leading-[1.5]'>
                    <div className='flex flex-col'>
                        <h3 className='font-bold font-open-sans text-[1.5rem] text-light-white mb-[1.5rem]'>{ t('usefulLinks') }</h3>
