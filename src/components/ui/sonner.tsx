  ...
  return (
    <Sonner
      ...
      toastOptions={{
        classNames: {
          toast:
            "group toast text-[1rem] group-[.toaster]:bg-light-white group-[.toaster]:text-dark-gray group-[.toaster]:border-gray/25 group-[.toaster]:shadow-custom rounded-[0.5rem] p-[1.5rem]",
