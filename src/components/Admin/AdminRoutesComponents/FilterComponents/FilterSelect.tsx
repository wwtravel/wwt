...
const FilterSelect: React.FC<FilterSelectProps> = ({ sortContition, setSortContition }) => {
  ...
  return (
    <Select value={sortContition} onValueChange={(value: "resAsc" | "resDesc" | "newest" | "oldest" | "none") => setSortContition(value)}>
      <SelectTrigger className={`relative font-open-sans xl:text-[1rem] text-[1.333rem] w-full xl:h-[3.5rem] h-[4.667rem] bg-light-white  md:rounded-[0.5rem] rounded-[0.667rem] border-gray/25 px-[1.5rem] py-0`}>
        <SelectValue placeholder={ t('default') } className="ring-0 text-[1rem] text-dark-gray font-open-sans font-[400]"/>
      </SelectTrigger>
      <SelectContent className="bg-light-white rounded-[0.5rem] border border-gray/25 z-[5000]">
        <SelectGroup className="z-[5000]">
          ...
          <SelectItem className="xl:text-[1rem] text-[1.333rem] text-dark-gray font-open-sans font-[400] py-[1rem] cursor-pointer" value="resAsc">
          ...
          <SelectItem className="xl:text-[1rem] text-[1.333rem] text-dark-gray font-open-sans font-[400] py-[1rem] cursor-pointer" value="resDesc">
            <div className="flex gap-[0.5rem] items-center">
          ...
          <SelectItem className="xl:text-[1rem] text-[1.333rem] text-dark-gray font-open-sans font-[400] py-[1rem] cursor-pointer" value="newest">
            <div className="flex gap-[0.5rem] items-center">
                <img src="/icons/admin-icons/icon-asc.svg" alt="ascendent" draggable={false} className="xl:size-[1rem] size-[1.333rem]" />
                <p>{ t('newest') }</p>
            </div>
          ...
          <SelectItem className="xl:text-[1rem] text-[1.333rem] text-dark-gray font-open-sans font-[400] py-[1rem] cursor-pointer" value="oldest">
            <div className="flex gap-[0.5rem] items-center">
                <img src="/icons/admin-icons/icon-desc.svg" alt="ascendent" draggable={false} className="xl:size-[1rem] size-[1.333rem]" />
                <p>{ t('latest') }</p>
            </div>
