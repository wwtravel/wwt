  ...
  return (
    ...
    >
        <div className="mt-[2rem] pt-[2rem] border-t border-gray/25 flex flex-row items-start justify-between">
            ...
            <div className="flex-1 flex items-stretch gap-[1.5rem]">
                ...
                <div className="flex items-center gap-[0.5rem]">
                    <div className='flex flex-col items-center mr-[0.5rem] py-[0.2rem] h-[5.5rem]'>
                    ...
                    <div className='h-full flex flex-col justify-between mr-[2rem]'>
                        <div className='flex items-center font-open-sans font-[400]'>
                            ...
                            <p className='text-[1rem] text-dark-gray mr-[0.5rem] line-clamp-1 text-nowrap'>{ order.departure_place.label[getLocale(locale)] }</p>
                        </div>
                        <div className='flex items-center font-open-sans font-[400]'>
                            <p className='text-[1rem] text-gray/75 mr-[0.5rem]'>{ route_t('finish') }:</p>
                            <p className='text-[1rem] text-dark-gray mr-[0.5rem] line-clamp-1 text-nowrap'>{ order.arrival_place.label[getLocale(locale)] }</p>
                        </div>
                    </div>
                </div>
            </div>
