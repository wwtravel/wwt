...
const Header = () => {
  ...
  return (
    <div className="relative lg:h-[calc(100dvh-14.25rem)] max-lg:pb-[2.667rem] bg-[url('/images/header_bg.webp')] bg-center bg-cover lg:px-[12rem] px-[1rem] lg:pt-[30vh] pt-[13.75rem]">
